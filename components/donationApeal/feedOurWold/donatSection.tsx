...
const DonateSection = () => {
    return (<div className="py-10 md:py-16 px-5 md:px-10 max-w-2xl mx-auto">
        <div>
            ...
            <p className="text-base text-center py-3">The reward of feeding the poor is immense, and the Qur’an tells us that the righteous “give food, out of love for Him, to the poor and the orphan and the captive, [saying] “We feed you, for Allah’s pleasure only — We desire from you neither reward nor thanks.” [76:5-12].</p>
            <p className="text-base text-center py-3">Supporting hunger relief not only provides us with the reward of feeding the poor, but it's also a beautiful way to gain Allah's (SWT) satisfaction.</p>
        </div>
        ...
        <div className="pt-16">
            ...
            <p className="text-base text-center py-3">We are working hard to tailor our existing programmes so that we can protect even more lives from Covid-19 - that’s why ove50% of our food distributions and sustainable agricultural projectwill also contain hygiene essential deliveries. </p>
