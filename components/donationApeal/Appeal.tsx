...
const AppealSection = () => {
    const appealList = [{ link: "palestine-emergency", img: "/donation/appeal/palestineEmergency.jpg", title: " Palestine Emergency", desc: "Stand in solidarity with Palestinians in Gaza." },
    { link: "palestine-emergency", img: "/donation/appeal/winter.jpg", title: "Winter Emergency", desc: "You could help save someone’s life during the harsh winter months." },
    ...
    { link: "feed-our-world", img: "/donation/appeal/feedOurWold.jpg", title: "Feed Our World", para: "“Feed for the love of Allah” – Qur’an 76:8", desc: "Show your love and compassion by helping to feed our world!" },
    ...
    return (<div className="py-16 bg-gray-200">
        <h2 className="text-teal-500 text-xl md:text-3xl py-8 lg:pt-16 font-semibold text-center">Our Current Appeals</h2>
        <div className="grid grid-cols-1 gap-5 md:gap-3 lg:grid-cols-4 lg:gap-6 md:grid-cols-3 px-5">
            {appealList.map((appeal, index) => <div className="p-2 pb-6 rounded-md bg-white hover:shadow-lg" key={index}>
                <Link href={`appeal/${appeal.link}`} className="group flex flex-col gap-2 justify-start">
                    <div className="relative overflow-hidden bg-cover bg-no-repeat">
                        <Image src={appeal.img} alt="" width={600} height={600} className="h-36 w-full transition duration-500 ease-in-out group-hover:scale-125" />
                    </div>
