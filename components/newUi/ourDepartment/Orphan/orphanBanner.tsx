...
const OrphanBannerSection = () => {
  ...
  return (
    <div className="pt-10 lg:pt-20">
      ...
      <div className="grid grid-cols-1 gap-8 md:gap-3 lg:gap-8 md:grid-cols-2 lg:grid-cols-3 pt-16 px-5">
        {/* <div className="flex flex-col gap-2">
          <h3 className=" text-2xl md:text-3xl text-gray-800"> Orphan</h3>
        ...
        <div className="flex flex-col items-center">
          <AnimationBottom>
            <div className="relative group overflow-hidden bg-sky-700 w-96 font-semibold text-xl py-3 px-8 md:text-2xl rounded-2xl">
          ...
          >
            ...
            >
              <Image
                src={"/finalIconAssets/OurdepatmentSlider/homeHand1.png"}
                alt=""
                width={700}
                height={700}
...
export default OrphanBannerSection;
