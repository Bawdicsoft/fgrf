...
const Hero = () => {
    ...
    return (
        <div className="md:h-[500px] h-[300px] w-full flex items-center text-white relative overflow-hidden">
            ...
            <div
                className="absolute animate-pulse md:block hidden maskanimation2 -bottom-[1%] right-0 w-full bg-no-repeat bg-center bg-cover z-[3] 2xl:h-[320px] xl:h-[260px] lg:h-[230px] h-[300px]"
