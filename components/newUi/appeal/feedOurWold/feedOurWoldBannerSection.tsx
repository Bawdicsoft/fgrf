...
const FeedOurWoldBannerSection = () => {
  ...
  const asCountryBtnList = [
    {
      title: "30",
      doc: "Could provide 30 meals for those struggling with hunger.",
    },
    {
      title: "60",
      doc: "Could provide 60 meals for those struggling with hunger.",
    },
    {
      title: "90",
      doc: "Could provide 90 meals for those struggling with hunger.",
    },
    {
      title: "365",
      doc: "Could provide 365 meals for those struggling with hunger.",
    },
  ];
