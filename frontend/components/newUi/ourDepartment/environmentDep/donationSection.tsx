...
export default function DonationSectionEnvironmentDepartment() {
  const cardArray = [
    ...
    <div className="max-w-screen-lg mx-auto px-4 md:px-4 xl:px-0">
      <div className="">
        ...
        <h2 className="text-center text-xl  md:text-3xl text-teal-500 font-bold pt-5 md:py-6">
          {" "}
          Started its climatic emergency action from Karachi by collaborating
          with KMC in an initiative Green Karachi.
        </h2>
        ...
        <div className="flex gap-4 md:gap-0 justify-between">
          <div className="md:w-5/12 h-24 md:h-52 lg:h-72">
            <Image
              src={"/ourDepartment/EnvironmentDepartment/plant/plant (9).jpg"}
              alt="about image"
              width={2000}
              height={2000}
          ...
          <div className="md:w-5/12 h-24 md:h-52 lg:h-72">
            <Image
              src={"/ourDepartment/EnvironmentDepartment/plant/plant (10).jpg"}
              alt="about image"
              width={2000}
              height={2000}
              className="h-full w-full"
