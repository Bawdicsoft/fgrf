...
const EnvironmentDepBannerSection = () => {
    ...
    <div className="pt-10 lg:pt-20">
      ...
      <div className="grid grid-cols-1 gap-8 md:gap-3 lg:gap-8 md:grid-cols-2 lg:grid-cols-3 pt-16 px-5">
        ...
        <div className="flex flex-col items-center">
          <AnimationBottom>
            <div className="relative group overflow-hidden bg-sky-700 w-full md:w-96 font-semibold text-xl py-3 px-2 md:px-8 md:text-2xl rounded-2xl">
          ...
          >
            ...
            >
              <Image
                src={"/finalIconAssets/OurdepatmentSlider/home1.png"}
                alt=""
                width={700}
                height={700}
...
export default EnvironmentDepBannerSection;
