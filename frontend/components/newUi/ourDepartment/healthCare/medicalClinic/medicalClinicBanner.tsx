...
const MedicalClinicBanner = () => {
  ...
  return (
    <div className="pt-5 xl:pt-10 px-4 xl:px-0">
      ...
      <div className="py-5">
        <Image
          src={"/ourDepartment/healthCare/medicalClinic/medical (7).png"}
          alt="about image"
          width={2000}
          height={2000}
...
export default MedicalClinicBanner;
