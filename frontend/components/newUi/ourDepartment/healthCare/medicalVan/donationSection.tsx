...
export default function DonationSectionMedicalVan() {
  const cardArray = [
    ...
    <div className="max-w-screen-lg mx-auto px-4 md:px-4 xl:px-0">
      <div className="">
        ...
        <h2 className="text-center text-xl  md:text-3xl text-teal-500 font-bold pt-5 md:py-6">
          Bringing Healthcare to Rural Areas, FGRF is proud to introduce our
        ...
        <AnimationBottom>
          <div className="border-4 border-sky-600 rounded-xl h-[250px] md:h-[450px] lg:h-[600px] w-full mx-auto my-8">
            <video className="h-full w-full rounded-lg object-fill" controls>
              <source
                src="/ourDepartment/videos/Health Care/Medical Van/medicalvan.mp4"
                type="video/mp4"
              />
            </video>
          </div>
