      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="relative"> Water Well</p>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 gap-8 md:gap-3 lg:gap-14 md:grid-cols-2 px-5">
        <AnimationTop>
          <AppealBannerAnimationLeft>
            ...
            >
              <Image
                src={`${(photos && photos[0]) || "/AppealNew/waterWell/1.jpg"}`}
                alt="winter img1"
        ...
        <AnimationTop>
          <AppealBannerAnimationRight>
            ...
            >
              <Image
                src={`${(photos && photos[1]) || "/AppealNew/waterWell/1.png"}`}
                alt="winter img1"
                className="w-full h-full rounded-lg"
                width={600}
                height={600}
...
export default WaterWellBannerSection;
