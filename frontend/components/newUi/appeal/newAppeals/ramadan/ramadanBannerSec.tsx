      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="relative">Ramadan</p>
          </div>
        </div>
      </div>
        ...
        <AnimationTop>
          <AppealBannerAnimationLeft>
            ...
            >
              <Image
                src={`${
                  (photos && photos[0]) || "/AppealNew/ramadan/ramadan (21).jpg"
                } `}
                alt="winter img1"
        ...
        <AnimationTop>
          <AppealBannerAnimationRight>
            ...
            >
              <Image
                src={`${
                  (photos && photos[1]) || "/AppealNew/ramadan/ramadan (22).jpg"
                } `}
                alt="winter img1"
                className="w-full h-full rounded-lg"
                width={600}
...
export default RamadanBannerSection;
