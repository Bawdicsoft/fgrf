      ...
      <div className="bg-gray-300 shadow-2xl mt-10 flex flex-col gap-2 max-w-3xl mx-auto rounded-lg">
        ...
        <div className="flex justify-center gap-5">
          <button
            className={
              bgColor
                ? `py-2 px-5 bg-teal-500 text-white text-lg rounded-b-3xl`
                : `bg-sky-800 text-white rounded-b-3xl py-2 px-5`
            }
            onClick={() => {
          ...
          <button
            className={
              !bgColor
                ? `py-2 px-5 bg-teal-500 text-white text-lg rounded-b-3xl`
                : `bg-sky-800 text-white py-2 px-5 rounded-b-3xl`
            }
            onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-2 pr-5 md:pr-0 pt-4 lg:pr-8 pb-3">
              {packeges.map((btn, index) => (
                <button
                  ...
                  className={
                    index === bgBtn
                      ? `border-0 border-white  text-white shadow-2xl bg-teal-500 py-1 px-2 rounded-xl text-xl font-semibold`
                      : `border-2 border-white text-teal-500  hover:bg-gray-400 py-1 px-2 rounded-xl font-semibold text-xl`
                  }
                  onClick={() => {
                    setDocs(index);
                    setbgBtn(index);
