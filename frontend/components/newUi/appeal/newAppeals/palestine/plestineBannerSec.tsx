      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p className="relative"> Palestine Emergency</p>
          </div>
        </div>
      </div>
        ...
        <AnimationTop>
          <AppealBannerAnimationLeft>
            ...
            >
              <Image
                src={`${
                  (photos && photos[0]) || "/AppealNew/palestine/12.png"
                }`}
                alt="winter img1"
          ...
          <AppealBannerAnimationRight>
            ...
            >
              <Image
                ...
                src={`${(photos && photos[1]) || "/AppealNew/palestine/5.png"}`}
                alt="winter img1"
                className="w-full h-full rounded-lg"
                width={600}
                height={600}
      ...
      <div className="bg-gray-300 md:h-96 shadow-2xl mt-10 px-3 lg:px-5 pb-5 max-w-3xl mx-auto rounded-lg">
        ...
        <div className="pt-3">
          <p className="text-black font-bold text-[13px] text-center ">
            Support FGRF to help affected Palestinian Muslims. Please note: Your
            donations can be used for any welfare, well-wishing, permissible,
            religious, reformatory, spiritual and good purpose.
          </p>
        </div>
      </div>
    </div>
