      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-50 block rounded-sm border bg-teal-500 p-1 shadow-sm  lg:hidden"
          >
            ...
            {/* <TfiLayoutListThumbAlt className="w-14 h-14" /> */}
          </button>
          {/* <!-- Hamburger Toggle BTN --> */}
        </div>
        ...
        <div className="hidden sm:block">
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <div className="bg-white rounded-full px-4 flex justify-between items-center">
                <RiSearchLine className="w-5 h-5 text-gray-700" />
                <input
                  type="text"
                  placeholder="Type to search..."
                  className="w-full bg-transparent font-medium focus:outline-none xl:w-125 p-2"
                />
              </div>
            </div>
          </form>
